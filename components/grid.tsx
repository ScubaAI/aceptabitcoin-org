...
function GridFloor({
  ...
  return (
    <mesh ref={meshRef} rotation={[rotateX, 0, 0]} position={position} scale={scale}>
...
export function Grid3D({
  ...
  const color = cellColor || themeColors[theme] || themeColors.tron
  ...
  return (
    <div className={className}>
      ...
      >
        ...
        <GridFloor color={color} cellSize={cellSize} cellThickness={cellThickness} rotateX={rotateX} position={position} scale={scale} />
