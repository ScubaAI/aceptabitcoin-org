...
export default function Hero() {
  return (
    <section className="min-h-screen pt-20 flex items-center relative overflow-hidden bg-black">
      {/* Fondo: Rejilla "Tron" + Ruido Digital */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 text-center relative z-10">
        ...
        {/* Header Terminal: Fuente Mono + Acento Cyan Tron */}
        ...
        {/* Título Principal: Fuente Serif (Patillas) + Brillo Naranja */}
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          {/* Botón Educativo: Estilo Tech Minimalista */}
          <Link 
            href="/aprende" 
